...
if __name__ == "__main__":
    # Initialize and run the server. Defaults to stdio (one process per
    # client); WHATSAPP_MCP_TRANSPORT=streamable-http serves a shared HTTP
    # endpoint instead (port registry: ~/CodeProjects/.meta/PORTS.md).
    import os
